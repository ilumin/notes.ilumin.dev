...
จากข้อเสีบ เราควรจะต้องพิจารณาว่า component ต่างๆมันมีความสัมพันธ์กันอย่างไร ถ้ามันไม่ได้ผูกกันมาก การใช้ context อาจจะทำให้ลำยากในการ maintain ดังนั้นอาจจะต้องพิจารณาใช้ solution อื่นมาแก้ปัญหา
...
จากโค้ด จะเห็นว่าเวลาเอาไปใช้จะใช้ง่ายมากๆ เรียกได้ว่าเป็นขั้นกว่าของ context ปกคิ เพราะมีแค่ `CountProvider`, `useCountState`, `useCountDispatch` ให้ใช้
